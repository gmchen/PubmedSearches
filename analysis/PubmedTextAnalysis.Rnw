...
t.test(title.length ~ time.period, consensus.review.df[consensus.review.df$journal=="jama",])
t.test(title.length ~ time.period, consensus.review.df[consensus.review.df$journal=="nejm",])
t.test(title.length ~ time.period, consensus.review.df[consensus.review.df$journal=="annals",])
t.test(title.length ~ time.period, consensus.review.df[consensus.review.df$journal=="bmj",])
t.test(title.length ~ time.period, consensus.review.df[consensus.review.df$journal=="lancet",])
@
